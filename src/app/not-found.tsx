...
import { Home, Search, Newspaper, Globe, Users, Mail, ArrowRight, MapPin } from 'lucide-react'
...
export default function NotFound() {
  return (
    ...
    >
      ...
      <main className="flex-1 max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-24 w-full">
        {/* Hero */}
        ...
        <div className="text-center">
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-6 py-3 bg-dc-green text-white rounded-lg font-semibold hover:bg-dc-green-dark transition-colors"
          >
